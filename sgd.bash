...
python main.py --optim-method SGD_Step_Decay --eta0 1 --alpha 0.16667 --weight-decay 0.0005 --train-epochs 164 --batchsize 128 --eval-interval 1 --use-cuda --log-folder ./logs/CIFAR100 --dataset CIFAR100 --dataroot ./data
